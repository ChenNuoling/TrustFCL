...
class Args:
    def __init__(self):
        ...
        # FedRBN 超参
        self.AT_ratio = 0.8  # AT用户比例
        self.lambda_pnc = 0.5  # PNC损失权重
...
class Recorder:
    ...
    def output_client_train(self, client_cid, client_task_id, loss, train_acc, train_time, client_type="AT"):
        """输出客户端训练信息"""
        self.log_print(f"    {client_type} Client {client_cid}: Task {client_task_id}, Loss={loss:.4f}, Train Acc={train_acc:.2f}, Time={train_time:.2f}s")
