...
class Args:
    def __init__(self):
        ...
        # Fcat 超参
        self.lambda1 = 0.1  # 因果损失权重
        self.lambda2 = 0.01  # KL散度正则化权重
        self.causal_layer_ratio = 0.5  # 因果模型插入位置比例 (0.0-1.0)
        self.causal_num_layers = 2  # 因果模型全连接层数 (2-3)
        self.causal_hidden_dim = 256  # 因果模型隐藏层维度
...
class Recorder:
    ...
    def output_server_agg(self, agg_time):
        """输出服务器聚合信息"""
        self.log_print("  > Step 2: Global BN Aggregation")
